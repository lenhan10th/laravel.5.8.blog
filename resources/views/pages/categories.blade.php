...
@section('content')
	<div class="inner-header">
	    <div class="container">
	        <div class="pull-left">
	            <h6 class="inner-title">Sản phẩm {!! $category_current->name !!}</h6>
	        </div>
	            ...
	            <div class="row">
	                <div class="col-sm-3">
	                    <ul class="aside-menu">
	                    	...
	                    	<li{{ $category->id == $category_current->id ? ' class=is-active' : '' }}><a href="{{ route('categories', $category->id) }}">{{ $category->name }}</a></li>
	                    	@endforeach
	                    	{{-- 
	                ...
	                <div class="col-sm-9">
	                    ...
	                    <div class="beta-products-list">
	                        <h4>Top Products</h4>
	                        <div class="beta-products-details">
	                            <p class="pull-left">{{ $products_top->total() }} styles found</p>
	                            <div class="clearfix"></div>
	                        </div>
	                        <div class="row">
                            	@php
	                        ...
	                        <div class="row">{{ $products_top->links() }}</div>
