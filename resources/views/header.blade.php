            ...
            <div class="pull-right beta-components space-left ov">
                ...
                <div class="beta-comp">
                    <form role="search" method="get" id="searchform" action="{{route('search')}}">
                        <input type="text" value="{{ Request::get('s') }}" name="s" id="s" placeholder="Nhập từ khóa..." />
                        <button class="fa fa-search" type="submit" id="searchsubmit"></button>
                    </form>
                </div>
                <div class="beta-comp">
                    <div class="cart">
                        <div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng ({!! Session::has('cart') ? number_format($total_qty) . ') <i class="fa fa-chevron-down"></i>' : 'Trống)' !!} </div>
                        <div class="beta-dropdown cart-body">
                            @if(Session::has('cart'))
                                ...
                                <div class="cart-caption">
                                    <div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">${{ number_format($total_price) }}</span></div>
                                    <div class="clearfix"></div>
                                    <div class="center">
                                        <div class="space10">&nbsp;</div>
                ...
                <ul class="l-inline ov">
                    ...
                    <li><a href="{{ route('products') }}">Sản phẩm</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ route('categories', $product_type->id) }}">{{ $product_type->name }}</a></li>
                            @endforeach
                        </ul>
                    </li>
